...
##assumes it's being run from setup_params: requires goldenline.R ran, obs_budget set
populate_optonly(init$mystringid, obs_budget)#2nd arg is observation budget
